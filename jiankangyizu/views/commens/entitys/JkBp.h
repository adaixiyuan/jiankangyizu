...
@interface JkBpDAO: ZUOYLDAOBase

@end
@interface JkBp : ZUOYLModelBase
...
@property(nonatomic,assign)int	pcp ;//TODO 高压
@property(nonatomic,assign)int	pdp ;//TODO 低压
@property(nonatomic,assign)int	heartRate ;//心率
