...
@interface JkGoodDoctorDAO : ZUOYLDAOBase

@end
@interface JkGoodDoctor : ZUOYLModelBase
...
@property(nonatomic,strong)NSString *	loginPassword ;//TODO 密码
...
@property(nonatomic,strong)NSString *bongUid;//bong用户Id
@property(nonatomic,strong)NSString *gudongUid;//咕咚用户Id
@property(nonatomic,strong)NSString *typeNo;
@property(nonatomic,strong)NSString *jkNo;
@property(nonatomic,assign)BOOL isQuit;//TODO 是否退出
