...
+ (CGSize)TextSize:(NSString *)string
{
    CGSize requiredSize = CGSizeZero;
    CGSize boundingSize = CGSizeMake(kDeviceWidth-145, MAXFLOAT);
    NSDictionary *attribute = @{NSFontAttributeName: [UIFont systemFontOfSize:12.0f]};
    //        [label1.text sizeWithAttributes:attribute];
    requiredSize = [string boundingRectWithSize:boundingSize options:\
