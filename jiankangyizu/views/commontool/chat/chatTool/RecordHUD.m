...
- (void)viewDidLoad
{
    ...
    UIView *bg=[[UIView alloc]initWithFrame:CGRectMake(75, 130, 170, 160)];
    ...
    seconds=[[UILabel alloc]initWithFrame:CGRectMake(75, 135, 160, 20)];
    ...
    voice=[[UIImageView alloc]initWithFrame:CGRectMake(122, 145, 75, 114)];
    ...
    UILabel *title=[[UILabel alloc]initWithFrame:CGRectMake(85, 259, 150, 20)];
    title.text=@"正在录音";
